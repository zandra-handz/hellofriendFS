...
CHANNEL_LAYERS = {
    'default': {
        ...
        'CONFIG': {
            ...
            'group_expiry': 3600, # channels auto-removed from groups after 1h of silence. default is 86400 (24h)
        },
        'POOL': {
            'max_connections': 10
        }
...
CACHES = {
    'default': {
        ...
        'LOCATION': f'redis://{os.getenv("REDIS_HOST", "127.0.0.1")}:6379/1',  # DB 1, channels is on 0
    }
}
...
GECKO_WS_JWT_SECRET = os.getenv("GECKO_WS_JWT_SECRET")
