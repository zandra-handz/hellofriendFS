...
urlpatterns = [
   ...
   # path('categories/history/capsules/', views.UserCapsulesHistoryView.as_view()),
    ...
    path("gecko-socket-token/", views.gecko_socket_token, name="gecko-socket-token"),
    ...
    path('gecko/game-wins/<int:pk>/pin/', views.GeckoGameWinPinDetail.as_view(), name='gecko-game-win-pin'),
