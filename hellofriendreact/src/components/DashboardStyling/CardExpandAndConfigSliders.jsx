...
import { FaWrench, FaArrowDown, FaCaretDown, FaCaretRight, FaArrowRight } from 'react-icons/fa';
import '/src/styles/OldStyles.css';
import Spinner from './Spinner';
import useThemeMode from '/src/hooks/UseThemeMode';

const CardExpandAndConfigSliders = ({ title, children, expanded, onEditButtonClick }) => {
...
export default CardExpandAndConfigSliders;
